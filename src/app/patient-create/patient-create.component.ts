...
export class PatientCreateComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.createForm = new FormGroup({
      ...
      SSN:new FormControl( [Validators.required, Validators.maxLength(13)]),
  ...
  onSubmit(){
    ...
    let patient = new Patient(this.patientService.patients.length + 1, this.createForm.value.fullName.firstName, this.createForm.value.fullName.lastName,  this.createForm.value.age,this.createForm.value.SSN);
