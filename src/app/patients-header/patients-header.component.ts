...
export class PatientsHeaderComponent implements OnInit {
  ...
  addPatient(firstName:HTMLInputElement, lastName:HTMLInputElement, age:HTMLInputElement,SSN:HTMLInputElement){
    this.patientsAdded.emit(new Patient(0,firstName.value, lastName.value, +age.value,+SSN.value));
